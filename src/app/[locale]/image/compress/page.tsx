...
import ImageToolsNav from "@/components/layout/ImageToolsNav";
import ImageCompress from "@/components/image-compress/ImageCompress";
...
export default async function ImageCompressPage({
  ...
  const t = await getTranslations("ImageCompress");
  ...
  const webAppSchema = {
    ...
    "@type": "WebApplication",
    name: t("title"),
    url: `https://neatoolkit.com/${locale}/image/compress`,
