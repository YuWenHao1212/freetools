...
import YouTubeTranslate from "@/components/youtube-translate/YouTubeTranslate";
...
export async function generateMetadata({
  ...
  return {
    title: t("youtubeTranslateTitle"),
    description: t("youtubeTranslateDescription"),
    openGraph: {
      title: t("youtubeTranslateTitle"),
      description: t("youtubeTranslateDescription"),
      url: `/${locale}/youtube/translate`,
    },
    alternates: {
...
export default async function YouTubeTranslatePage({
  params,
}: {
  params: Promise<{ locale: string }>;
}) {
  ...
  const t = await getTranslations("YouTubeTranslate");
  ...
  const relatedTools = [
    ...
    },
    {
      ...
      title: t("relatedTools.summary"),
      description: t("relatedTools.summaryDesc"),
    },
  ];
  ...
  const webAppSchema = {
    ...
    "@type": "WebApplication",
    name: t("title"),
    url: `https://neatoolkit.com/${locale}/youtube/translate`,
    ...
    <div className="flex min-h-screen flex-col">
      ...
      <main className="flex-1">
        ...
        <section className="pb-12">
          <div className="mx-auto max-w-7xl px-6 2xl:max-w-[1600px]"><YouTubeTranslate /></div>
        </section>
