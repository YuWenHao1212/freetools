...
import YouTubeSubtitle from "@/components/youtube-subtitle/YouTubeSubtitle";
...
export async function generateMetadata({
  ...
  return {
    title: t("youtubeSubtitleTitle"),
    description: t("youtubeSubtitleDescription"),
    openGraph: {
      title: t("youtubeSubtitleTitle"),
      description: t("youtubeSubtitleDescription"),
      url: `/${locale}/youtube/subtitle`,
    },
    alternates: {
...
export default async function YouTubeSubtitlePage({
  params,
}: {
  params: Promise<{ locale: string }>;
}) {
  ...
  const t = await getTranslations("YouTubeSubtitle");
  ...
  const webAppSchema = {
    ...
    "@type": "WebApplication",
    name: t("title"),
    url: `https://neatoolkit.com/${locale}/youtube/subtitle`,
    ...
    <div className="flex min-h-screen flex-col">
      ...
      <main className="flex-1">
        ...
        <section className="pb-12">
          <div className="mx-auto max-w-7xl px-6 2xl:max-w-[1600px]"><YouTubeSubtitle /></div>
        </section>
